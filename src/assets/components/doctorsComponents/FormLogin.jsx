      ...
      <div className="mt-8">
        ...
        <div className="mt-8 flex flex-col gap-y-4">
          <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01]
           ease-in-out transition-all py-3 rounded-xl bg-customBlue text-white text-lg
            font-bold" onClick={() => navigate('/role/LoginAsDoctor/dashboard')}>
            Sign in
          </button>
          <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl border-2 border-customBlue text-customBlue text-lg font-bold"
          onClick={() => navigate('/role/RegisterAsDoctor')}>
            Create account
          </button>
        </div>
      </div>
